...
class Game():
    def __init__(self):
        ...
        self.player_sprite = Player((x, y), player_speed, self.layout_play_rect, self.screen, self.get_player_image(), self.space)
    ...
    def write_info(self):
        ...
        self.layout_info.write(3, 'Neodimio', str(self.num_residuos).zfill(5))
        ...
        self.layout_info.write(11, 'Shield Time', str(self.player_sprite.get_shield_up_time()).zfill(5))
