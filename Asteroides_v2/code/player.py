...
class Player(pygame.sprite.Sprite):
    def __init__(self, pos, speed, constraint):
        super().__init__()
        self.image = pygame.image.load('../graphics/ship/nave-1-00.png')
        self.image_recharge = [pygame.image.load('../graphics/ship/nave-1-01.png'),
                               pygame.image.load('../graphics/ship/nave-1-02.png'),
                               pygame.image.load('../graphics/ship/nave-1-03.png'),
                               pygame.image.load('../graphics/ship/nave-1-04.png'),
                               pygame.image.load('../graphics/ship/nave-1-05.png'),
                               pygame.image.load('../graphics/ship/nave-1-00.png'),]
