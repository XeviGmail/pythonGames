...
class Game():
    def __init__(self, space, screen):
        ...
        self.player_sprite = Player((screen_width/2, screen_height-10), speed_player, (0, screen_width, 0, screen_height), self.get_player_image())
...
if __name__ == '__main__':
    ...
    icono = pygame.image.load('../graphics/icon/icon.png')
